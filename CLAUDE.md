...
テストは2層に分ける。**まずドメイン知識テスト(設計書)を書いて設計を駆動し、その結果
実装したコードに対して単体テストも書く**、という順で進める。

### Tier 1: ドメイン知識テスト(設計書) — `spec/knowledge/`
...
### Tier 2: 単体テスト — `spec/zoo/`(ファイル=クラス)
...
- Tier 1 = 「飼育員や生物学者が“動物園について真”と認めること」
